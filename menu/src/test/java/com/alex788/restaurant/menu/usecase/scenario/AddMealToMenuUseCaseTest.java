...
import static com.alex788.restaurant.menu.usecase.Fixtures.TestMealPersister;
...
class AddMealToMenuUseCaseTest {
    ...
    void execute_InInvariant_PersistMeal() {
        ...
        Either<AddMealToMenu.UseCaseError, MealId> mealIdEth = useCase.execute(request);
    ...
    void execute_OutOfInvariant_ReturnsError() {
        ...
        Either<AddMealToMenu.UseCaseError, MealId> mealIdEth = useCase.execute(new AddMealToMenu.AddMealToMenuRequest(
                mealName(),
                mealDescription(),
                mealPrice()
        ));
        ...
        assertInstanceOf(AddMealToMenu.NameMustBeUniqueUseCaseError.class, mealIdEth.getLeft());
    }
}